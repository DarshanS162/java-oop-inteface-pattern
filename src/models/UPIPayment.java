...
public class UPIPayment implements Payment,DiscountPolicy{

    private final double amount;
    private final double discountRate;
    private final TransLogger logger;

    public UPIPayment(double amount, double discountRate, TransLogger logger) {
        this.amount = amount;
    ...
    public PaymentResult pay() {
       ...
       double tax = calculateTax(amount, 30);
       double discount = newYearDiscount();
       double totalAmount = amount + tax - discount;
       printPaymentDetails(tax, discount, totalAmount);
       logger.log("UPI payment of: " + amount + " is received.");
       return new PaymentResult(PaymentStatus.SUCCESS, "UPI12345", "Payment Successful", totalAmount);
    } 
